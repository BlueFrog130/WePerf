...
export default {
    data(){
        return{
            // Manually adding routes for future plans
            routes: [
                {name: 'iperf', path: '/iperf', title: 'iPerf', icon: 'mdi-access-point'},
                {name: 'mininet', path: '/mininet', title: 'Mininet', icon: 'mdi-console-network'}
            ]
        }
    }
}
